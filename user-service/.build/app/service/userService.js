...
const password_2 = require("./../utility/password");
const password_3 = require("./../utility/password");
...
const dataHelper_1 = require("../utility/dataHelper");
...
let UserService = class UserService {
    ...
    CreateUser(event) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const hashedPassword = yield (0, password_2.GetHashedPassword)(input.password, salt);
                ...
                /* eslint-disable */ console.log(...oo_oo(`2514101334_50_6_50_24_4`, error));
    ...
    LoginUser(event) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const verified = yield (0, password_3.ValidatePassword)(input.password, data.password, data.salt);
                if (!verified) {
                ...
                /* eslint-disable */ console.log(...oo_oo(`2514101334_74_8_74_26_4`, error));
                return (0, response_1.ErrorResponse)(500, error);
            }
        });
    }
    GetVerificationToken(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, response_1.SuccessResponse)({ message: "response code is send to your registered mobile number" });
        });
    }
    VerifyUser(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!payload)
                return (0, response_1.ErrorResponse)(403, "authorization failed!");
            const input = (0, class_transformer_1.plainToClass)(UpdateInput_1.VerificationInput, JSON.parse(event.body));
            const error = yield (0, errors_1.AppValidationError)(input);
            if (error)
                return (0, response_1.ErrorResponse)(404, error);
            ...
            if (verification_code === parseInt(input.code)) {
                ...
                const diff = (0, dataHelper_1.TimeDifference)(expiry, currentTime.toISOString(), "m");
                if (diff > 0) {
                    /* eslint-disable */ console.log(...oo_oo(`2514101334_113_8_113_49_4`, "verification successfully!"));
                    // update on DB
    ...
    CreateProfile(event) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const input = (0, class_transformer_1.plainToClass)(AddressInput_1.ProfileInput, JSON.parse(event.body));
                const error = yield (0, errors_1.AppValidationError)(input);
                if (error)
                    return (0, response_1.ErrorResponse)(404, error);
                ...
                /* eslint-disable */ console.log(...oo_oo(`2514101334_143_6_143_24_4`, error));
                return (0, response_1.ErrorResponse)(500, error);
            }
        });
    }
    GetProfile(event) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                /* eslint-disable */ console.log(...oo_oo(`2514101334_159_6_159_24_4`, error));
                return (0, response_1.ErrorResponse)(500, error);
            }
        });
    }
    EditProfile(event) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (error)
                    return (0, response_1.ErrorResponse)(404, error);
                /* eslint-disable */ console.log(...oo_oo(`2514101334_177_6_177_28_4`, 'check 2'));
                ...
                /* eslint-disable */ console.log(...oo_oo(`2514101334_182_6_182_24_4`, error));
                return (0, response_1.ErrorResponse)(500, error);
            }
        });
    }
